...
public void OnPluginStart(){
	...
	Cvar_Bans_ServerURL = CreateConVar("timer_cash_bans_url", "strafeodyssey.com", "Set the link to display in the kick message");

	Cvar_EnableAntiStrafe = CreateConVar("timer_cash_enable_antistrafe", "0", "READ CAREFULLY - With this enabled, it will block out many more cheats. HOWEVER. It will also detect people using +strafe. Use at own risk.");

	AutoExecConfig(true, "cash", "timer");

	BuildPath(Path_SM, PLUGIN_LOGFILE, PLATFORM_MAX_PATH, "logs/bTimes-CASH.txt");
}
